...
angular.module("obrasMduytApp").directive("tipoChart", function() {
	return {
		...
		template:			
			"<div class='row chart-item'><div id='tipo-chart' ng-show='total_obras_by_tipo.length'></div><div class='col-md-2'><p></p></div><div class='col-md-12 label-slug'><h3></h3></div></div>",
		replace: true,
